...
const FeedCard = ({ thumbnail }) => {
	...
	return (
		<Paper withBorder radius='md' className={classes.card} p={20}>
			...
			<Group mt='md' p='md' position='apart'>
				<Group position='left' spacing='lg'>
					<Group position='apart' spacing='lg'>
						<Group>
							<ActionIcon>
								<IconHeart size={35} color='white' />
							</ActionIcon>
							500
						</Group>
						<Group>
							<ActionIcon>
								<IconMessageCircle2 size={35} color='white' />
							</ActionIcon>
							34
						</Group>
						<Group>
							<ActionIcon>
								<IconSend size={35} color='white' />
							</ActionIcon>
						</Group>
					</Group>
				</Group>
				...
				<Group position='right'>
					<ActionIcon>
						<IconEye size={35} color='white' />
					</ActionIcon>
					1000 views
				</Group>
			</Group>

			<Stack p='md' align='flex-start' justify='center'>
				<Group position='apart'>
					<Text weight={500} color='white'>
						efrei_paris
					</Text>
					<Text color='white' weight='thin'>
						Wei 2022.
					</Text>
				</Group>
				<Group position='apart'>
